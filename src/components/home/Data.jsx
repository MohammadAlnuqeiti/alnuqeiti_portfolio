...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Mohammad Alnuqeiti
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">A web design and development professional passionate about crafting visually stunning online experiences using many technologies.</p>
